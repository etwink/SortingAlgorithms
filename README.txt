...
The GUI is not very intuitive or elegant at the moment, but hopefully it will be addressed soon. The biggest concern is that the program was working and the visualization of the sorting algorithms is also working.

To run this file on Windows, make sure you have Python 3 installed as well as the matplotlib library. The version of Python that was used during testing was Python 38. The command "python -m pip install -U matplotlib" can be run to install the matplotlib library.
